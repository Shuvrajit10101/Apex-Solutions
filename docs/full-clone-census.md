...
| | **TOTAL** | **216** | **46** | **102** | **68** | **0** |

**A full clone requires 216 named capabilities. We have 46 complete, 102 partial, 68 absent, 0 undetermined.**
...
> awk, not edited: its literal output is `TOTAL rows=216 C=46 P=102 A=68 U=0 sum=216`.
...
**▶ 🔴 EXPECTED RUN FROM 2026-09-04 (WAVE-3 FOLD-IN) ONWARD: `TOTAL rows=216 C=46 P=102 A=68 U=0 sum=216`.**
...
#### Area 12 — Printing · 9 rows · 1 complete / 4 partial / 4 absent
...
> - **TIER 0 now holds fourteen rows**, T0-21 having been added 2026-09-04 (professional-tax slabs shipped as
