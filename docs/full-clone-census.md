...
|---|---|---:|---:|---:|---:|---:|
| 1 | Company creation & configuration (F11/F12) | 9 | 1 | 7 | 1 | 0 |
...
| | **TOTAL** | **221** | **52** | **159** | **10** | **0** |

**A full clone requires 221 named capabilities. We have 52 complete, 159 partial, 10 absent, 0 undetermined.**
...
#### Area 1 — Company creation & configuration (F11/F12) · 9 rows · 1 complete / 7 partial / 1 absent
