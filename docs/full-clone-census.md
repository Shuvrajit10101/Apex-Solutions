...
| 7 | Payroll | 21 | 6 | 13 | 2 | 0 |
| 8 | Banking | 10 | 1 | 6 | 3 | 0 |
...
| | **TOTAL** | **216** | **52** | **122** | **42** | **0** |

**A full clone requires 216 named capabilities. We have 52 complete, 122 partial, 42 absent, 0 undetermined.**
...
**▶ 🔴 EXPECTED RUN FROM 2026-09-07 (A15's RE-DERIVATION AT `90413a9`) ONWARD:
...
#### Area 7 — Payroll · 21 rows · 6 complete / 13 partial / 2 absent
...
#### Area 8 — Banking · 10 rows · 1 complete / 6 partial / 3 absent
