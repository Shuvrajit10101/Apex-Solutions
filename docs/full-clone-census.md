...
| 5 | Voucher behaviours & edit verbs | 15 | 6 | 8 | 1 | 0 |
| 6 | Statutory, current law (GST, TDS/TCS, salary IT) | 42 | 18 | 20 | 4 | 0 |
| 7 | Payroll | 26 | 6 | 18 | 2 | 0 |
...
| 15 | Statutory, obsolete by law (pre-GST) — **was §3** | 6 | 0 | 0 | 6 | 0 |
| 16 | Formerly excluded by decision (security, audit, data structure) — **was §4** | 7 | 0 | 5 | 2 | 0 |
| | **TOTAL** | **221** | **52** | **146** | **23** | **0** |

**A full clone requires 221 named capabilities. We have 52 complete, 146 partial, 23 absent, 0 undetermined.**
...
#### Area 5 — Voucher behaviours & edit verbs · 15 rows · 6 complete / 8 partial / 1 absent
...
#### Area 7 — Payroll · 26 rows · 6 complete / 18 partial / 2 absent
...
#### Area 15 — Statutory, obsolete by law (pre-GST) · 6 rows · 0 complete / 0 partial / 6 absent
