...
public static class VoucherEffects
{
    ...
    /// <summary>Whether the base kind is one of the eight stock/order voucher kinds (an inventory voucher).</summary>
    ...
    /// <summary>Whether the base kind is a Purchase-Order or Sales-Order (order-only, no effect).</summary>
    public static bool IsOrderBaseType(VoucherBaseType baseType) => baseType is
        VoucherBaseType.PurchaseOrder or VoucherBaseType.SalesOrder;
}
