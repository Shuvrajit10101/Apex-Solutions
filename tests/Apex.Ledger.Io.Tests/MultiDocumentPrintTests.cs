...
public sealed class MultiDocumentPrintTests
{
    ...
    /// </summary>
    /// <summary>
    /// 🔴 <b>Narrowed by RULING 18.</b> The old fixture was <c>Doc("Tally Ltd", "Tally Opening")</c> and demanded
    /// that BOTH vanish. The second string is a body cell — book data, the particulars column — so the assertion
    /// was locking in the de-brander rewriting a party's name on the printed page. The job's own heading is
    /// product-authored and still scrubbed; the body row moved to <c>CounterpartyNameExportTests</c>.
    /// </summary>
    [Fact]
