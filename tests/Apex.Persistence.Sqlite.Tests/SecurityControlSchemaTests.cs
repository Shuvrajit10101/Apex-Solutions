...
public sealed class SecurityControlSchemaTests
{
    ...
    public void Migration_v55_to_v56_matches_CreateV1()
    {
        ...
        try
        {
            ...
            {
                SchemaDowngrade.V63ToV62(conn); SchemaDowngrade.V62ToV61(conn); SchemaDowngrade.V61ToV60(conn); SchemaDowngrade.V60ToV59(conn); SchemaDowngrade.V59ToV58(conn); SchemaDowngrade.V58ToV57(conn); SchemaDowngrade.V57ToV56(conn); SchemaDowngrade.V56ToV55(conn);
