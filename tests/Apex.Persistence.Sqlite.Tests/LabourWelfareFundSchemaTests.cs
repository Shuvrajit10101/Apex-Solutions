...
public sealed class LabourWelfareFundSchemaTests
{
    ...
    public void Migration_v62_to_v63_matches_CreateV1()
    {
        ...
        try
        {
            ...
            using (var conn = Open(migratedPath)) { SchemaDowngrade.V63ToV62(conn); SqliteConnection.ClearPool(conn); }
    ...
    public void A_migrated_book_leaves_every_pre_existing_slab_perpetual()
    {
        ...
        try
        {
            ...
            using (var conn = Open(path)) { SchemaDowngrade.V63ToV62(conn); SqliteConnection.ClearPool(conn); }
    ...
    public void A_v61_book_climbs_the_whole_ladder_and_gets_BOTH_v62_and_v63_objects()
    {
        ...
        try
        {
            ...
            using (var conn = Open(laddered)) { SchemaDowngrade.V63ToV62(conn); SqliteConnection.ClearPool(conn); }
