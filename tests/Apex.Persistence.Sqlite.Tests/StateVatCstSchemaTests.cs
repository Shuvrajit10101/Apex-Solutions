...
public sealed class StateVatCstSchemaTests
{
    ...
    public void Migration_v58_to_v59_matches_CreateV1()
    {
        ...
        try
        {
            ...
            using (var conn = Open(migratedPath)) { SchemaDowngrade.V62ToV61(conn); SchemaDowngrade.V61ToV60(conn); SchemaDowngrade.V60ToV59(conn); SchemaDowngrade.V59ToV58(conn); SqliteConnection.ClearPool(conn); }
    ...
    public void A_migrated_v58_book_is_ordinary_GST_goods_with_no_VAT_anywhere()
    {
        ...
        try
        {
            ...
            using (var conn = Open(path)) { SchemaDowngrade.V62ToV61(conn); SchemaDowngrade.V61ToV60(conn); SchemaDowngrade.V60ToV59(conn); SchemaDowngrade.V59ToV58(conn); SqliteConnection.ClearPool(conn); }
    ...
    public void The_downgrade_drops_only_the_v59_columns_and_keeps_every_primary_key()
    {
        ...
        try
        {
            ...
            {
                SchemaDowngrade.V62ToV61(top); SchemaDowngrade.V61ToV60(top); SchemaDowngrade.V60ToV59(top);
